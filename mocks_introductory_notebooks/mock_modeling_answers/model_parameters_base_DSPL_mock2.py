...
# REDSHIFT PARAMETERS
# For Mock Images, be sure to read off the correct redshifts from the mock data files. 
z_l = 0.3
z_s1 = 1.3
z_s2 = 1.7
...
# Shear parameters
kwargs_shear_init =   {'gamma_ext': 0.006915106152231696,
...
kwargs_lens_light_init = [{
    ...
    'e1': kwargs_sie_init['e1'],
    'e2': kwargs_sie_init['e2'],
...
kwargs_source_init = [
    {
        ...
        'center_x': kwargs_sie_init_src['center_x'],
        'center_y': kwargs_sie_init_src['center_y']
    },
    {
        ...
        'center_x': 0.00432046384621248,
        'center_y': -0.30843669475658164
    },
    # {
