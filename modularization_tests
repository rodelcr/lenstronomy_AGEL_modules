...
lens_redshift_list = [z_l]
source_redshift_list = [z_s1, z_s2, z_s2]
...
lens_center_ra = 0.09789233337522507
lens_center_dec = 0.020403937171283193
lens_bound = 0.05
source_bound = 1.0
...
kwargs_sie_init = {
    ...
    'center_x': 0.09789233337522507,
    'center_y': 0.020403937171283193
}
...
kwargs_lens_init = [kwargs_sie_init, kwargs_shear_init]
kwargs_lens_sigma = [kwargs_sie_sigma, kwargs_shear_sigma]
kwargs_lens_fixed = [kwargs_sie_fixed, kwargs_shear_fixed]
kwargs_lower_lens = [kwargs_sie_lower, kwargs_shear_lower]
kwargs_upper_lens = [kwargs_sie_upper, kwargs_shear_upper]
